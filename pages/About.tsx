...
const About: React.FC = () => {
  ...
  return (
    <div className="w-full animate-fade-in">
      ...
      <section className="px-4 md:px-6 pt-32 pb-24 md:pt-48 md:pb-32 bg-background relative z-10">
      ...
      {/* 2. Expandable Image Section (Pinned & Growing Upwards) */}
      {/* height를 500vh로 설정하여 스크롤 영역을 기존 대비 200%로 확보 */}
      <section ref={expanderSectionRef} className="relative h-[500vh] bg-background">
        <div className="sticky top-0 h-screen w-full flex flex-col justify-end overflow-hidden">
          {/* 바닥에 붙어서(bottom-0) 위로 자라나는 이미지 컨테이너 */}
          <div 
      ...
      {/* 3. Why Flair Factory? (Pinned Section) */}
      <section className="relative h-[250vh] bg-background">
        <div className="sticky top-0 h-screen flex flex-col justify-center px-4 md:px-6">
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex items-end justify-between mb-16 border-b border-primary/10 pb-4">
      ...
      {/* 4. Business Areas (Pinned Section) */}
      <section className="relative h-[250vh] bg-background">
        <div className="sticky top-0 h-screen flex flex-col justify-center px-4 md:px-6">
          <div className="max-w-7xl mx-auto w-full">
      ...
      {/* 5. Process (Pinned Section & Hover Image) */}
      <section className="relative h-[300vh] bg-background">
        <div className="sticky top-0 h-screen flex flex-col justify-center px-4 md:px-6">
          ...
          {/* Floating Image Container (Fixed position to follow mouse inside Sticky) */}
          <div 
            ref={cursorImgRef}
