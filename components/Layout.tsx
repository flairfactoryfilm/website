  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-primary selection:bg-primary/20 transition-colors duration-300">
      ...
      <header className="fixed top-0 left-0 w-full z-50 px-4 md:px-6 py-5 flex items-center justify-between">
        ...
        {/* Logo */}
        <NavLink to="/" className="text-primary hover:opacity-80 transition-opacity" aria-label="LUMINA Home">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="mb-2 text-primary">
              <LogoSvg className="h-4 w-auto" />
            </div>
            <p className="text-secondary text-sm max-w-xs break-keep">
              미래 지향적인 브랜드를 위한 몰입형 비주얼 경험을 제작합니다.
            </p>
          </div>
          <div className="flex gap-6 text-sm text-secondary uppercase tracking-wider">
            <a href="#" className="hover:text-primary transition-colors">Instagram</a>
            <a href="#" className="hover:text-primary transition-colors">Vimeo</a>
            <a href="#" className="hover:text-primary transition-colors">LinkedIn</a>
          </div>
        </div>
        <div className="mt-12 flex justify-between items-center text-xs text-primary/20">
          <span>© {new Date().getFullYear()} Lumina Productions. All rights reserved.</span>
